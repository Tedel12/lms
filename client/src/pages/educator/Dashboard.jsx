    ...
    <div className='min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
        <div className='flex flex-wrap gap-5 items-center'>
          <div className='flex items-center gap-3 shadow-card border border-blue-500 p-2 px-5 w-56 rounded-md'>
            ...
            <div>
              ...
              <p className='text-base text-gray-500'>Total des inscriptions</p>
            </div>
          </div>
          <div className='flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md'>
            ...
            <div>
              ...
              <p className='text-base text-gray-500'>Total des cours</p>
            </div>
          </div>
          <div className='flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md'>
            <img src={assets.earning_icon} alt="patients" />
            <div>
              <p className='text-2xl font-medium text-gray-600'>{dashboardData.enrolledStudentsData.length} {currency}</p>
              <p className='text-base text-gray-500'>Gains totaux</p>
            </div>
          </div>
        </div>

        <div>
          <h2 className='pb-4 text-lg font-medium'>Inscriptions récentes</h2>
